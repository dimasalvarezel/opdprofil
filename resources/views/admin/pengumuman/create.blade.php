            ...
            <div class="col-md-12">
              ...
              <div class="card card-success">
                <div class="card-header">
                  <h3 class="card-title"><strong>Tambahkan Data Pengumuman</strong></h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form role="form" action="{{route('admin.announcement.add')}}" id="quickForm" method="post" enctype="multipart/form-data">
                  @csrf
                  <div class="card-body">
                    <div class="form-group">
                      <label for="title">Judul Pengumuman</label>
                      <input type="text" name="title" class="form-control" id="title" placeholder="Masukkan Judul Pengumuman">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="custom-file">
                          ...
                          <label class="custom-file-label" for="file">Unggah File/Dokumen</label>
                      </div>
                    </div>
                    <div class="form-group">
