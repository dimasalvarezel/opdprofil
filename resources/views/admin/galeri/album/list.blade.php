                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{$list->status}}</td>
                      <td>
                        <a href="{{route('admin.album.show',['id' => $list->id])}}" class="btn btn-md btn-secondary btn-icon" title="Detail">
                          <i class="fas fa-info-circle"></i>
                        </a>
                        <a href="{{route('admin.album.edit',['id' => $list->id])}}" class="btn btn-md btn-success btn-icon" title="Edit">
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            <form id="hapus-data" action="{{ route('admin.album.delete') }}" method="POST" class="d-none">
                              @csrf
