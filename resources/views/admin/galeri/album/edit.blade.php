          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="card card-success">
                <!-- /.card-header -->
                <!-- form start -->
                <form role="form" action="{{route('admin.album.update')}}" id="quickForm" method="post" enctype="multipart/form-data">
                  @csrf
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="custom-file">
                          ...
                          <label class="custom-file-label" for="img">{{($fetch->thumbnail)?$fetch->thumbnail:'Unggah Gambar'}}</label>
                      </div>
                    </div>
                    <div class="form-group">
