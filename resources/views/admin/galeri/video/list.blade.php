          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Data Video Terbaru</h3>
                <a href="{{route('admin.video.create')}}" class="btn btn-success float-right">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{$list->status}}</td>
                      <td>
                        <a href="{{route('admin.video.show',['id' => $list->id])}}" class="btn btn-md btn-secondary btn-icon" title="Detail">
                          <i class="fas fa-info-circle"></i>
                        </a>
                        <a href="{{route('admin.video.edit',['id' => $list->id])}}" class="btn btn-md btn-success btn-icon" title="Edit">
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            <form id="hapus-data" action="{{ route('admin.video.delete') }}" method="POST" class="d-none">
                              @csrf
