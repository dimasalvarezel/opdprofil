            ...
            <div class="col-md-12">
              ...
              <div class="card card-success">
                <div class="card-header">
                  <h3 class="card-title"><strong>Tambahkan Foto</strong></h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form role="form" action="{{route('admin.photo.add')}}" id="quickForm" method="post" enctype="multipart/form-data">
                  @csrf
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="name" class="form-control" id="name" placeholder="Masukkan Judul Gambar">
                    </div>
                    <div class="form-group">
