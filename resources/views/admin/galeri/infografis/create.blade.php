            ...
            <div class="col-md-12">
              ...
              <div class="card card-success">
                <div class="card-header">
                  <h3 class="card-title"><strong>Tambahkan Data Info Grafis</strong></h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form role="form" action="{{route('admin.infographic.add')}}" id="quickForm" method="post" enctype="multipart/form-data">
                  @csrf
                  <div class="card-body">
...
<script type="text/javascript">
  ...
  $(document).ready(function () {
    $('#quickForm').validate({
      ...
      messages: {
        title: {
          required: "&nbsp;"+"Kolom tidak boleh kosong, masukkan judul info grafis",
        },
        description: {
          required: "&nbsp;"+"Kolom tidak boleh kosong, masukkan deskripsi info grafis",
        },
        img: {
          required: "&nbsp;"+"Kolom tidak boleh kosong, masukkan gambar info grafis",
