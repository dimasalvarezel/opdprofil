          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Data Bidang Unit Kerja</h3>
                <a href="{{route('admin.field.create')}}" class="btn btn-success float-right">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{ $row->status }}</td>
                      <td>
                        <a href="{{route('admin.field.edit',['id' => $row->id])}}" class="btn btn-md btn-success btn-icon" title="Edit">
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            <form id="hapus-data" action="{{ route('admin.field.delete') }}" method="POST" class="d-none">
                              @csrf
