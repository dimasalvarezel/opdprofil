      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item text-green"><small><strong>Trash</strong></small></li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Tong Sampah Data Artikel</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="{{route('admin.trash.restore',['id' => $list->id])}}" class="btn btn-md btn-success btn-icon" title="Pulihkan">
                          <i class="fas fa-trash-restore"></i>
                        </a>
                        <a href="#" data-toggle="modal" data-target="#hapus{{$list->id}}" class="btn btn-md btn-danger btn-icon" title="Hapus Data">
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            <form id="hapus-data" action="{{ route('admin.trash.destroy') }}" method="POST" class="d-none">
                              @csrf
