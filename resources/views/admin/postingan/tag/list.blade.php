          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Data Tag Terbaru</h3>
                <a href="{{route('admin.tag.create')}}" class="btn btn-success float-right">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>{{ $row->status }}</td>
                    <td>
                      <a href="{{route('admin.tag.edit',['id' => $row->id])}}" class="btn btn-md btn-success btn-icon" title="Edit">
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          <form id="hapus-data" action="{{ route('admin.tag.delete') }}" method="POST" class="d-none">
                            @csrf
