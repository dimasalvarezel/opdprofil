          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Data Kategori Terbaru</h3>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{ $row->status }}</td>
                      <td>
                        <a href="{{route('admin.category.edit',['id' => $row->id])}}" class="btn btn-md btn-success btn-icon" title="Edit">
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            <form id="hapus-data" action="{{ route('admin.category.delete') }}" method="POST" class="d-none">
                              @csrf
