          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Daftar Gambar Banner/Slider Terbaru</h3>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>{{$list->name}}</td>
                      <td><img src="{{asset('storage/slider/images/'.$list->img)}}" style="width:auto;height:60px"></td>
                      <td>{{$list->status}}</td>
                      <td>
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            <form id="hapus-data" action="{{ route('admin.slider.delete') }}" method="POST" class="d-none">
                              @csrf
