      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item"><small><strong>Sliders</strong></small></li>
            ...
            <div class="col-md-12">
              ...
              <div class="card card-success">
                <div class="card-header">
                  <h3 class="card-title"><strong>Tambahkan Gambar Banner/Slider</strong></h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form role="form" action="{{route('admin.slider.add')}}" id="quickForm" method="post" enctype="multipart/form-data">
                  @csrf
                  <div class="card-body">
                    <div class="form-group">
                      <label for="name">Judul</label>
                      <input type="text" name="name" class="form-control" id="name" placeholder="Masukkan Judul Banner">
                    </div>
                    <div class="form-group">
...
<script type="text/javascript">
  $(document).ready(function () {
    $('#quickForm').validate({
      ...
      messages: {
        title: {
          required: "&nbsp;"+"Kolom tidak boleh kosong, masukkan judul gambar",
        },
        description: {
          required: "&nbsp;"+"Kolom tidak boleh kosong, masukkan deskripsi gambar",
        }
      },
      errorElement: 'span',
