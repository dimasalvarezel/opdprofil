        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-12 col-lg-8">
                <div class="list-group">
                    <a href="https://goo.gl/maps/qdbZb1cWkUJo52aV6" target="_blank" class="list-group-item list-group-item-action">UPTD Pertanian</a>
                    <a href="https://goo.gl/maps/wUMTfU5S98aKGKZ4A" target="_blank" class="list-group-item list-group-item-action">UPTD Dinas Pendidikan</a>
                    <a href="https://goo.gl/maps/rmPiyFVzoraEMvj46" target="_blank" class="list-group-item list-group-item-action">UPTD Pertanian</a>
                </div>
            </div>
