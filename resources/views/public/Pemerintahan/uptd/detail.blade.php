@extends('public.layout.app', ['title' => $UPTD->title])

@section('meta')
  <meta name="description" content="{{htmlspecialchars($UPTD->short_description)}}" />
  <meta name="keywords" content="{{htmlspecialchars($UPTD->title)}}" />
  <meta property="og:title" content="{{$UPTD->title}} "/>
  <meta property="og:type" content="{{$UPTD->title}}"/>
  <meta property="og:image" content="{{($UPTD->img)?asset('/storage/article/images/'.$UPTD->img):asset('fontend/images/grid/1.jpg')}}"/>
@endsection
    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-12">
          <h1 class="pagetitle__heading">{{$UPTD->title}}</h1>
        </div><!-- /.col-lg-12 -->
      </div><!-- /.row -->
    </div><!-- /.container -->
  </section><!-- /.page-title -->
