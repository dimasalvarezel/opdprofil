@extends('public.layout.app', ['title' => $topography->title])

@section('meta')
  <meta name="description" content="{{htmlspecialchars($topography->short_description)}}" />
  <meta name="keywords" content="{{htmlspecialchars($topography->title)}}" />
  <meta property="og:title" content="{{$topography->title}} "/>
  <meta property="og:type" content="{{$topography->title}}"/>
  <meta property="og:image" content="{{($topography->img)?asset('/storage/article/images/'.$topography->img):asset('fontend/images/grid/1.jpg')}}"/>
@endsection
    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-12">
          <h1 class="pagetitle__heading">{{$topography->title}}</h1>
        </div><!-- /.col-lg-12 -->
      </div><!-- /.row -->
    </div><!-- /.container -->
  </section><!-- /.page-title -->
