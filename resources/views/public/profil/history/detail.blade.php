@extends('public.layout.app', ['title' => $history->title])

@section('meta')
  <meta name="description" content="{{htmlspecialchars($history->short_description)}}" />
  <meta name="keywords" content="{{htmlspecialchars($history->title)}}" />
  <meta property="og:title" content="{{$history->title}} "/>
  <meta property="og:type" content="{{$history->title}}"/>
  <meta property="og:image" content="{{($history->img)?asset('/storage/article/images/'.$history->img):asset('fontend/images/grid/1.jpg')}}"/>
@endsection
    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-12">
          <h1 class="pagetitle__heading">{{$history->title}}</h1>
        </div><!-- /.col-lg-12 -->
      </div><!-- /.row -->
    </div><!-- /.container -->
  </section><!-- /.page-title -->
