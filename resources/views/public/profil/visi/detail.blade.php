@extends('public.layout.app', ['title' => $Visi->title])

@section('meta')
  <meta name="description" content="{{htmlspecialchars($Visi->short_description)}}" />
  <meta name="keywords" content="{{htmlspecialchars($Visi->title)}}" />
  <meta property="og:title" content="{{$Visi->title}} "/>
  <meta property="og:type" content="{{$Visi->title}}"/>
  <meta property="og:image" content="{{($Visi->img)?asset('/storage/article/images/'.$Visi->img):asset('fontend/images/grid/1.jpg')}}"/>
@endsection
    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-12">
          <h1 class="pagetitle__heading">{{$Visi->title}}</h1>
        </div><!-- /.col-lg-12 -->
      </div><!-- /.row -->
    </div><!-- /.container -->
  </section><!-- /.page-title -->
