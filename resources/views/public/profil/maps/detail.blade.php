@extends('public.layout.app', ['title' => $Maps->title])

@section('meta')
  <meta name="description" content="{{htmlspecialchars($Maps->short_description)}}" />
  <meta name="keywords" content="{{htmlspecialchars($Maps->title)}}" />
  <meta property="og:title" content="{{$Maps->title}} "/>
  <meta property="og:type" content="{{$Maps->title}}"/>
  <meta property="og:image" content="{{($Maps->img)?asset('/storage/article/images/'.$Maps->img):asset('fontend/images/grid/1.jpg')}}"/>
@endsection
    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-12">
          <h1 class="pagetitle__heading">{{$Maps->title}}</h1>
        </div><!-- /.col-lg-12 -->
      </div><!-- /.row -->
    </div><!-- /.container -->
  </section><!-- /.page-title -->
