@extends('public.layout.app', ['title' => 'Info Grafis Terbaru'])

@section('meta')
  <meta name="description" content="Info Grafis Terbaru" />
  <meta name="keywords" content="Diskominfo Subang" />
  <meta property="og:title" content="Info Grafis Terbaru"/>
  <meta property="og:type" content="Info Grafis"/>
    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-12">
          <h1 class="pagetitle__heading">Info Grafis</h1>
        </div><!-- /.col-lg-12 -->
      </div><!-- /.row -->
    </div><!-- /.container -->
  </section><!-- /.page-title -->
          ...
          <div class="col-sm-12 col-md-12 col-lg-8">
            <div class="row">
              ...
              @foreach ($infografis as $data)
                <div class="col-sm-12 col-md-6 col-lg-6">
                  <div class="blog-item">
                    <div class="blog__img">
                      <a href="{{route('public.infographic.detail',['slug'=>$data->slug])}}">
                        <img height="180px" width="180px"  src="{{($data->thumbnail) ? asset('/storage/gallery/infographic/thumbs/'.$data->thumbnail) : asset('frontend/images/features/2.jpg')}}" alt="{{$data->title}}">
                      </a>
                    </div><!-- /.entry-img -->
                    <div class="blog__content">
                      ...
                      <h4 class="blog__title"><a href="{{route('public.infographic.detail',['slug'=>$data->slug])}}">{{$data->title}}</a></h4>
                      <p class="blog__desc">{{$data->description}}</p>
                      <a href="{{route('public.infographic.detail',['slug'=>$data->slug])}}" class="btn btn__secondary btn__link">Selengkapnya</a>
                    </div><!-- /.entry-content -->
                  </div><!-- /.blog-item -->
                </div><!-- /.col-lg-4 -->
              @endforeach
            ...
            <div class="row">
              <div class="col-sm-12 col-md-12 col-lg-12 text-center">
                ...
                <div>{{ $infografis->links('public.layout.pagination') }}</div>
