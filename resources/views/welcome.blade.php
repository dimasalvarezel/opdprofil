...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Kecamatan Serangpanjang</title>
        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                    <p>Web Kecamatan Serangpanjang</p>
                    <!-- bagian di atas hanya contoh -->
                    <!-- lamun bisa bagian ieu pake style *codenya bisa di cari di getbootstrap.com/docs/5.0/getting-started/introduction/ -->
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                            <div class="flex items-center">
                                <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" class="w-8 h-8 text-gray-500">
                                    <!-- di bagian bawah coba tanyakn ka alumni anu bagian anu ngoding, carana ker ngamunculkn gambar, tunjukn wh kodinganna -->
                                    <path d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"> 
                                    </path>
                                </svg>
                                <div class="ml-4 text-lg leading-7 font-semibold">
                                    <a href=" ubah ka link $link_1 " class="underline text-gray-900 dark:text-white">Dokumentasi <!-- nama sementara, bisa di ubah --> </a>
                                </div>
                            </div>
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold">
                                    <a href=" ubah link ka $link_2 " class="underline text-gray-900 dark:text-white">Foto Dokumentasi <!-- nama sementara, bisa di ubah --> </a>
                                </div>
                            </div>
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold">
                                    <a href="ubah link ka $link_3" class="underline text-gray-900 dark:text-white">Berita <!-- nama sementara, bisa di ubah --> </a>
                                </div>
                            </div>
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
                            <div class="flex items-center">
                                <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" class="w-8 h-8 text-gray-500">
                                    <!-- di bagian bawah coba tanyakn ka alumni anu bagian ngoding, carana ker ngamunculkn gambar, tunjukn wh kodinganna -->
                                    <path d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                </svg>
                                <div class="ml-4 text-lg leading-7 font-semibold">
                                    <a href="ubah link ka $link_4" class="underline text-gray-900 dark:text-white">Denah <!-- nama sementara, bisa di ubah --> </a>
                                </div>
                            </div>
