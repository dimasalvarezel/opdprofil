...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div style="padding-left:10px; padding-top:10px; padding-bottom:5px;">
        ...
        <p>> <span>SOME PAGES ON THIS SERVER THAT YOU DO HAVE PERMISSION TO ACCESS</span>:<br>
             <span style="padding-left:18px;color:#fff;">[ <a href="{{route('public.homepage')}}">Home Page</a> | <a href="{{route('public.contact')}}">Contact Us</a> ]</span>
        </p>
